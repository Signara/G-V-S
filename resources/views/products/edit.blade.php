                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Name') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('Name', $product->Name) }}" required="true" aria-required="true" />
                                        ...
                                        <div class="form-group{{ $errors->has('Company') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Company"
                                                ...
                                                <option value="{{ $company->id }}"
                                                    {{ $company->id == old('Company', $product->Company) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Price') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Price') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('Price', $product->Price) }}" required="true" aria-required="true" />
