...
@section('content')
    <div class="container">
                        ...
                        <div class="text-center row">
                            <div class="col-lg-2">
                                <div class="card-avatar">
                                    <a href="{{ route('blog.author', $article->slug) }}">
                                        @if($article->author->picture == '')
                                        <img class="img" src="{{ asset('material') }}/img/company-profile-placeholder.png">
                                        @else
        ...
        <!---<div class="section section-comments">
            <div class="row">
                <div class="ml-auto mr-auto col-md-8">
                    <div class="media-area">
                        <h3 id="comments" class="text-center title">{{ $article->comments->count() . __(' Comments') }}</h3>
            ...
            <div class="ml-auto mr-auto col-md-8">
                <form method="post" enctype="multipart/form-data" action="{{ route('blog.comments.store', $article->slug) }}"
                    ...
                    @csrf
                    <h3 class="text-center title">{{ __('Post your comment') }}</h3>
                    <div class="media media-post">
                        <a class="float-left author d-none d-sm-inline" href="{{ route('blog.author', $article->author->slug) }}">
                            <div class="avatar">
                                @if(auth()->user()->picture == '')
                                <img class="media-object" src="{{ asset('material') }}/img/company-profile-placeholder.png">
                                @else
                        ...
                        <div class="media-body">
                            ...
                            <div class="media-footer">
                                <button type="submit"
                                    class="float-right btn btn-primary btn-round btn-wd">{{ __('Post Comment') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            @guest
                <div class="row">
                    <div class="ml-auto mr-auto col-lg-6 col-md-6 col-sm-3">
        ...
        <div style="display:none" id="replyForm" class="ml-auto mr-auto col-md-8">
            <form method="post" enctype="multipart/form-data" action="{{ route('blog.comments.store', $article->slug) }}"
                autocomplete="off" class="form-horizontal">
                @csrf
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-center title">{{ __('More ') }}<a href="{{ route('blog.category', $article->category->slug) }}">{{ $article->category->name }}</a>{{ __(' Articles') }}</h2>
                        <div class="row">
                                    ...
                                    <div class="card card-blog">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-description">
                                                {{ Str::limit($categoryArticle->excerpt, '50') }}
