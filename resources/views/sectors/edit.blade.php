@extends('dashboard.layouts.app', [
    'activePage' => 'sector-management',
    'menuParent' => 'laravel',
    'titlePage' => __('Industry Management')
])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('sector.update', $sector) }}" autocomplete="off"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Edit Industry') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('name', $sector->name) }}" required="true"
                                                aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('slug', $sector->slug) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                            <textarea cols="30" rows="10"
                                                ...
                                                aria-required="true">{{ old('description', $sector->description) }}</textarea>
