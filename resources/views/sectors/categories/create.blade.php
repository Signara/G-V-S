...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('category.store', $sector) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="text-right col-md-12">
                                        <a href="{{ route('category.index', $sector) }}"
                                        ...
                                        <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <input type="file" name="photo" id="input-picture" accept="image/*">
