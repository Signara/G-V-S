...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('sector.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Add Industry') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                        ...
                                        <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <input type="file" name="photo" id="input-picture" accept="image/*" required="true" aria-required="true">
