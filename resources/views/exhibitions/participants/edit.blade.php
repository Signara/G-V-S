...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" id="exhbtn-form" enctype="multipart/form-data" action="{{ route('participant.update', [$exhibition , $participant]) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Edit participant') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('Company') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" id="Company" name="Company"
                                                ...
                                                <option value="{{ $company->id }}"
                                                    {{ $company->id == old('Company', $participant->Company) ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group{{ $errors->has('Products') ? ' has-danger' : '' }}">
                                            <select class="form-control col-sm-4 Products" name="Products[]"
                                                ...
                                                <option value="{{ $product->id }}"
                                                    {{ in_array($product->id, old('Products', $selectedProduct) ?? []) ? 'selected' : '' }}>
                                                    {{ $product->Name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group{{ $errors->has('ParticipantType') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="ParticipantType"
                                                ...
                                                <option value="{{ $participanttype->id }}"
                                                    {{ $participanttype->id == old('ParticipantType', $participant->ParticipantType) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Package') ? ' has-danger' : '' }}">
                                            <select class="form-control col-sm-4 Package" name="Package"
                                                data-style="select-with-transition" id="packages" multiple title="" data-size="7" required="true" aria-required="true">
                                                <option value="">-</option>
                                                @foreach ($packages as $package)
                                                <option value="{{ $package->id }}"
                                                    {{ $package->id == old('Package', $participant->Package) ? 'selected' : '' }}>
                                                    {{ $package->Name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('StartDate') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('StartDate') ? ' is-invalid' : '' }} datepicker"
                                                ...
                                                value="{{ old('StartDate', $participant->StartDate) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('StartTime') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('StartTime') ? ' is-invalid' : '' }} timepicker"
                                                ...
                                                value="{{ old('StartTime', $participant->StartTime) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('EndDate') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('EndDate') ? ' is-invalid' : '' }} datepicker"
                                                ...
                                                value="{{ old('EndDate', date('m/d/Y', strtotime($participant->EndDate))) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('EndTime') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('EndTime') ? ' is-invalid' : '' }} timepicker"
                                                ...
                                                value="{{ old('EndTime', $participant->EndTime) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('products_allowed') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('products_allowed') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('products_allowed', $participant->products_allowed) }}" required="true" aria-required="true" />
                                        ...
                                        <div class="form-group{{ $errors->has('Admins') ? ' has-danger' : '' }}">
                                            <select class="form-control col-sm-4 Admins" name="Admins[]"
                                                ...
                                                <option value="{{ $user->id }}"
                                                    {{ in_array($user->id, old('Admins', $selectedUser) ?? []) ? 'selected' : '' }}>
                                                    {{ $user->name }}</option>
                                                @endforeach
                                            </select>
