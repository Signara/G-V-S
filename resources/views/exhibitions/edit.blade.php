...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('exhibition.update', $exhibition) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Edit exhibitions') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                @if ($exhibition->info_image)
                                                <img src="{{ $exhibition->pathssss() }}" alt="...">
                                                @else
                                                <img src="{{ asset('material') }}/img/image_placeholder.jpg" alt="...">
                                                @endif
                                            </div>
                                            ...
                                            <div>
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <span class="fileinput-exists">{{ __('Change') }}</span>
                                                    <input type="file" name="inf_img" id="input-inf_img" />
                                                </span>
                                                <a href="#pablo" class="btn btn-danger fileinput-exists"
                                                    data-dismiss="fileinput"><i class="fa fa-times"></i>
                                                    {{ __('Remove') }}</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <?php $slug = @explode('/',$exhibition->PDF); ?>
                                                <a href="{{ Storage::disk('public')->path($exhibition->PDF) }}" target="_blank" alt="..">{{ $slug[1] ?? '' }}</a>
                                            </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                            <div>
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <span class="fileinput-exists">{{ __('Change') }}</span>
                                                    <input type="file" name="pdf" id="input-pdf" />
                                                </span>
                                                <a href="#pablo" class="btn btn-danger fileinput-exists"
                                                    data-dismiss="fileinput"><i class="fa fa-times"></i>
                                                    {{ __('Remove') }}</a>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Name') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('Name', $exhibition->Name) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('display_name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('display_name') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('display_name', $exhibition->display_name) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('slug', $exhibition->slug) }}" required="true" aria-required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Description') ? ' has-danger' : '' }}">
                                            <textarea cols="30" rows="5" class="form-control{{ $errors->has('Description') ? ' is-invalid' : '' }}" name="Description" id="input-Description" type="text" placeholder="{{ __('Description') }}" required="true" aria-required="true">{{ old('Description', $exhibition->Description) }}</textarea>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('keywords') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('keywords') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('keywords', $exhibition->keywords) }}" required="true" aria-required="true" />
                                        ...
                                        <div class="form-group{{ $errors->has('Sector') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Sector[]"
                                                ...
                                                <option value="{{ $sector->id }}"
                                                    {{ in_array($sector->id, old('Sector', $selectdSector) ?? []) ? 'selected' : '' }}>
                                                    {{ $sector->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Tag') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Tag[]"
                                                ...
                                                @foreach ($tags as $tag)
                                                <option value="{{ $tag->id }}"
                                                    {{ in_array($tag->id, old('Tag', $selectdTag) ?? []) ? 'selected' : '' }}>
                                                    {{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group{{ $errors->has('StartDate') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('StartDate') ? ' is-invalid' : '' }} datepicker"
                                                ...
                                                value="{{ old('StartDate', date('m/d/Y', strtotime($exhibition->StartDate))) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group{{ $errors->has('StartTime') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('StartTime') ? ' is-invalid' : '' }} timepicker"
                                                ...
                                                value="{{ old('StartTime', $exhibition->StartTime) }}" />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group{{ $errors->has('EndDate') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('EndDate') ? ' is-invalid' : '' }} datepicker"
                                                ...
                                                value="{{ old('EndDate', date('m/d/Y', strtotime($exhibition->EndDate))) }}" required="true" aria-required="true" />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group{{ $errors->has('EndTime') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('EndTime') ? ' is-invalid' : '' }} timepicker"
                                                ...
                                                value="{{ old('EndTime', $exhibition->EndTime) }}" required="true" aria-required="true" />
                                        ...
                                        <div class="form-group{{ $errors->has('Organiser') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Organiser"
                                                ...
                                                <option value="{{ $company->id }}"
                                                    {{ $company->id == old('Organiser', $exhibition->Organiser) ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group{{ $errors->has('Admins') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Admins[]"
                                                ...
                                                <option value="{{ $user->id }}"
                                                    {{ in_array($user->id, old('Admins', $selectdUser) ?? []) ? 'selected' : '' }}>
                                                    {{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group{{ $errors->has('Packages') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="Packages[]"
                                                ...
                                                <option value="{{ $package->id }}"
                                                    {{ in_array($package->id, old('Packages', $selectdPackage) ?? []) ? 'selected' : '' }}>
                                                    {{ $package->Name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('facebook') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('facebook') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('facebook', $exhibition->facebook) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('twitter') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('twitter') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('twitter', $exhibition->twitter) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('instagram') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('instagram') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('instagram', $exhibition->instagram) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('youtube') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('youtube') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('youtube', $exhibition->youtube) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('linkedin') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('linkedin') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('linkedin', $exhibition->linkedin) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('android_link') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('android_link') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('android_link', $exhibition->android_link) }}" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('ios_link') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('ios_link') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('ios_link', $exhibition->ios_link) }}" />
