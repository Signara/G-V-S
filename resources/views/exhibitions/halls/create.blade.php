...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('hall.store', $exhibition) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Add hall') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('SrNo') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('SrNo') ? ' is-invalid' : '' }}"
                                                ...
                                                value="{{ old('SrNo') }}" required="true" aria-required="true" />
                            ...
                            <div class="ml-auto mr-auto card-footer">
                                <button type="submit" class="btn btn-rose">{{ __('Add Hall') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
