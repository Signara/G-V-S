...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('exhibitionRelGallery.update', [$exhibition , $exhibitionrelgallery]) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Edit Expo Media') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                @if ($exhibitionrelgallery->gallery)
                                            ...
                                            <div>
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <input type="file" name="gallary" id="input-gallary" />
                                                </span>
