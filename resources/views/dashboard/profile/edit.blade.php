                            ...
                            <form method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <option value="{{ $countrycode->id }}"
                                            {{ $countrycode->id == old('country_code', auth()->user()->country_code) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control{{ $errors->has('Phone') ? ' is-invalid' : '' }}" name="Phone" id="input-Phone" type="text" placeholder="{{ __('Phone') }}" value="{{ old('Phone', auth()->user()->Phone) }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input class="form-control{{ $errors->has('Designation') ? ' is-invalid' : '' }}" name="Designation" id="input-Designation" type="text" placeholder="{{ __('Designation') }}" value="{{ old('Designation', auth()->user()->Designation) }}" required />
                                        ...
                                        <div class="form-group{{ $errors->has('CompanyID') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="CompanyID"
                                                ...
                                                <option value="{{ $company->id }}"
                                                    {{ $company->id == old('CompanyID', auth()->user()->CompanyID) ? 'selected' : '' }}>
