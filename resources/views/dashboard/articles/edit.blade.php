...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" id="article-form" enctype="multipart/form-data" action="{{ route('article.update', $article) }}"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('read_time') ? ' has-danger' : '' }}">
                                            <input type="number" name="read_time" id="read_time"
                                                ...
                                                value="{{ old('read_time',$article->read_time)}}" required="true" aria-required="true"/>
