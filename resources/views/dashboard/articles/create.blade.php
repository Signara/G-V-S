...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" id="article-form" enctype="multipart/form-data" action="{{ route('article.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="category_id"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('content') ? ' has-danger' : '' }}">
                                            <textarea id="editor" name="content" value="" required>
                                                {!! old('content') !!}
                                            </textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('tags') ? ' has-danger' : '' }}">
                                            <select class="pl-0 pr-0 selectpicker col-sm-12" name="tags[]"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('read_time') ? ' has-danger' : '' }}">
                                            <input type="number" name="read_time" id="read_time"
                                                ...
                                                value="{{ old('read_time')}}" required="true" aria-required="true" />
        ...
        $(document).ready(function () {
            ...
            $("#article-form").validate({
                ...
                messages: {
                    ...
                    read_time: "Read Time is required",
                }
            });
