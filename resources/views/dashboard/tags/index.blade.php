                          ...
                          @can('manage-articles', App\User::class)
                            <td class="text-right td-actions">
                              <form action="{{ route('tag.destroy', $tag) }}" method="post">
                                ...
                                @method('delete')
                                @can('update', $tag)
                                  <a class="btn btn-success btn-link" href="{{ route('tag.edit', $tag) }}" data-original-title="" title="Edit">
                                    <i class="material-icons">edit</i>
                                    <div class="ripple-container"></div>
                                  </a>
                                @endcan
                                <button type="button" class="btn btn-danger btn-link" data-original-title="" title="Delete" onclick="confirm('{{ __("Are you sure you want to delete this tag?") }}') ? this.parentElement.submit() : ''">
