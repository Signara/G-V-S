                            ...
                            <div class="row">
                                <div class="text-right col-12">
                                    <a href="{{ route('package.create') }}"
                                        class="btn btn-sm btn-rose">{{ __('Add packages') }}</a>
                                </div>
                            </div>
                                            ...
                                            <td class="text-right td-actions">
                                                <form action="{{ route('package.destroy', $package) }}" method="post">
                                                    ...
                                                    <a class="btn btn-success btn-link"
                                                        href="{{ route('package.edit', $package) }}" data-original-title=""
                                                        title="Edit">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-link"
                                                        ...
                                                        onclick="confirm('{{ __("Are you sure you want to delete this package?") }}') ? this.parentElement.submit() : ''">
